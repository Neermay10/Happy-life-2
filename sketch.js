...
function preload(){
    ...
    parkBench = loadImage("./image/parkBench.jpg");
    smallApartment = loadImage("./image/smallApartment.jpg");
    house = loadImage("./image/house.jpg");
    grandEstate = loadImage("./image/grandEstate.jpg");
    apartmentComplex = loadImage("./image/apartmentComplex.jpg");
    skyscraper = loadImage("./image/skyscraper.jpg");
}
